...
// 타입은 question-types.ts(leaf)에 정의 — generated-questions.ts 와의 순환 방지. 재노출로 기존 import 유지.
export type { Question, SubjectKey, QuestionDifficulty, QuestionType, QuestionSource }
