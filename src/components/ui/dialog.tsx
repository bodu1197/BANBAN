// @client-reason: Radix UI Dialog primitive requires client-side rendering
"use client"
...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // z-[110]: 모달은 최상단. admin 레이아웃 쉘(fixed inset-0 z-[100] 불투명)보다 위여야
        // admin 안에서 Dialog 가 가려지지 않는다. z-50 으로 낮추지 말 것.
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // z-[110]: overlay 와 동일 레이어. admin 쉘(z-[100] 불투명)보다 위. z-50 으로 낮추지 말 것.
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus-visible:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
