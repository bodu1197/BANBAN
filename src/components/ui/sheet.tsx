// @client-reason: Radix UI Dialog (Sheet) primitive requires client-side rendering
"use client"
...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // z-[110]: 모달 오버레이는 앱의 어떤 크롬보다도 위여야 한다. 가장 높은 불투명 크롬이
        // admin 쉘(admin-layout-shell.tsx, z-[100])이므로 그 위 z-[110]. Dialog 와 동일 레이어. z-50 금지.
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          // z-[110]: overlay 와 동일 레이어(가장 높은 불투명 크롬 admin 쉘 z-[100] 보다 위). z-50 금지.
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus-visible:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
