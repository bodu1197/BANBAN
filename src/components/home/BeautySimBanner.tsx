        ...
        return (
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center gap-2 text-center">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-pink-500 to-purple-500 shadow-md">
                        <Eye className="h-5 w-5 text-white" aria-hidden="true" />
                    </div>
                    <div className="inline-flex items-center rounded-full bg-white/10 px-2 py-0.5 text-[10px] font-bold text-pink-300">
                        FREE
                    </div>
    ...
    return (
        <div className="px-4 py-3">
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 h-24 w-24 rounded-full bg-purple-500/15 blur-3xl" />

                <div className="relative z-10 flex items-center gap-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-purple-500 shadow-md">
                        <Eye className="h-6 w-6 text-white" aria-hidden="true" />
                    </div>
                    <div className="min-w-0 flex-1">
                        <div className="mb-0.5 inline-flex items-center gap-1 rounded-full bg-white/10 px-2 py-0.5 text-[10px] font-bold text-pink-300 backdrop-blur-sm">
                            FREE
                        </div>
