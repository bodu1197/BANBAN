...
const STATIC_PAGES: StaticEntry[] = [
  ...
  // 시술별 허브 — 큰 검색어("눈썹 반영구" 등)를 받는 본문 4,500자+ 페이지(2026-09-07).
  { path: "/guide",              priority: "0.8", changefreq: "weekly" },
  { path: "/guide/eyebrow",      priority: "0.9", changefreq: "weekly" },
  { path: "/guide/lip",          priority: "0.9", changefreq: "weekly" },
  { path: "/guide/eyeliner",     priority: "0.9", changefreq: "weekly" },
  { path: "/guide/hairline",     priority: "0.9", changefreq: "weekly" },
  { path: "/guide/mens-eyebrow", priority: "0.9", changefreq: "weekly" },
  { path: "/guide/smp",          priority: "0.9", changefreq: "weekly" },
