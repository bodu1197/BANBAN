...
export async function GET(request: NextRequest): Promise<NextResponse> {
    const artistType = request.nextUrl.searchParams.get("artistType") as "TATTOO" | "SEMI_PERMANENT" | null;
    const validType = artistType === "TATTOO" || artistType === "SEMI_PERMANENT" ? artistType : undefined;
