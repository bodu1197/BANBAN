...
const SEO_DESCRIPTION =
  "반언니에서 제공하는 반영구 시술 할인, 신규 회원 가입 혜택, 시즌 기획전, 한정 프로모션과 쿠폰을 한곳에서 확인하세요. 매주 새로운 혜택이 업데이트되며 인기 아티스트의 특가 상품과 재방문 고객 전용 혜택도 함께 안내합니다.";
...
export default async function Page(): Promise<React.ReactElement> {
  ...
  return (
    <div className="mx-auto w-full max-w-[1024px] px-0 py-6">
