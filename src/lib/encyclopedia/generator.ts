...
function buildPrompt(topic: EncyclopediaTopic): string {
  ...
  return [
    `# 작성 임무`,
    `"${SITE_NAME}" 뷰티 백과사전에 게시할 **최소 3,500자 이상 (4,000자 권장)** 분량의 한국어 전문 정보 글을 작성하세요.`,
    `**⚠️ 3,000자 미만은 품질 미달로 거부됩니다. 각 section의 body는 최소 300자 이상이어야 합니다.**`,
    ``,
    `## 주제 정보`,
    `- 카테고리: ${topic.category}`,
    ...
    `  "sections": [`,
    `    { "heading": "소제목 (H2, 키워드 포함)", "body": "본문 최소 300자 (여러 문단, \\n\\n 구분. 마크다운 테이블·불릿 사용 가능)" },`,
    `    { "heading": "...", "body": "..." },`,
    `    { "heading": "...", "body": "..." },`,
    `    { "heading": "...", "body": "..." },`,
    `    { "heading": "...", "body": "..." },`,
